    ...
    <div>
        ...
        <li style={{ listStyleType: 'disc' }}>
          ...
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              Phat Contract 1.0 on main net <code>Expected Q1</code>
              <ul className="bulleted-list">
                <li style={{ listStyleType: 'square' }}>
                  Revolutionary "Stake to Compute" model, say goodbye to gas
                  fees
                </li>
              </ul>
            </li>
          ...
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              "Phat Bricks"<code>Expected Q1</code>
              <ul className="bulleted-list">
                <li style={{ listStyleType: 'square' }}>
          ...
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              Even more "Phat Bricks" <code>Expected Q2</code>
              <ul className="bulleted-list">
                <li style={{ listStyleType: 'square' }}>
          ...
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              Phat Contract 2.0 <code>Expected Q3/Q4</code>
              <ul className="bulleted-list">
                <li style={{ listStyleType: 'square' }}>
        ...
        <li style={{ listStyleType: 'disc' }}>
          ...
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              ...
              <code>Expected Q2</code>
            </li>
          </ul>
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              Phala Builders Program "Free Staking"<code>Expected Q2</code>
              <ul className="bulleted-list">
                <li style={{ listStyleType: 'square' }}>
          ...
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              Phat Contract Academy <code>Expected Q3</code>
            </li>
          </ul>
        </li>
      </ul>
        ...
        <li style={{ listStyleType: 'disc' }}>
          ...
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              ...
              and offline <code>Year Round</code>
            </li>
          </ul>
        </li>
      </ul>
      <h2 className="">Compute</h2>
      <p className="">
      ...
      <ul className="bulleted-list">
        <li style={{ listStyleType: 'disc' }}>
          ...
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              SGX 2.0 <code>Expected Q3/Q4</code>
            </li>
          </ul>
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              Add a second hardware implementation <code>Expected Q3/Q4</code>
            </li>
          </ul>
        </li>
      </ul>
      <h2 className="">PhalaWorld</h2>
      <p className="">
        ...
        <li style={{ listStyleType: 'disc' }}>
          ...
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              ...
              <ul className="bulleted-list">
                <li style={{ listStyleType: 'square' }}>
                  Supporting the trade &amp; transfer of Shell NFT and
                  StakePoolV2 NFT
                </li>
              </ul>
            </li>
      ...
      <ul className="bulleted-list">
        <li style={{ listStyleType: 'disc' }}>
          ...
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              "Visualise all your Phala NFT's"<code>Expected Q2</code>
              <ul className="bulleted-list">
                <li style={{ listStyleType: 'square' }}>
      ...
      <ul className="bulleted-list">
        <li style={{ listStyleType: 'disc' }}>
          ...
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              CyperMod 1.0 <code>Expected Q3/Q4</code>
              <ul className="bulleted-list">
                <li style={{ listStyleType: 'square' }}>
                  Hello EVM "Dressup".
                </li>
      ...
      <h2 className="">Super Secret Product</h2>
      <p className="">
      ...
      <ul className="bulleted-list">
        <li style={{ listStyleType: 'disc' }}>
          Elevate our Presence and Message
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
      ...
      <ul className="bulleted-list">
        <li style={{ listStyleType: 'disc' }}>
          ...
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              Refreshed Technical Whitepaper <code>Expected Q3/Q4</code>
            </li>
          </ul>
          <ul className="bulleted-list">
            <li style={{ listStyleType: 'circle' }}>
              Tokenomics Whitepaper vNext <code>Expected Q3/Q4</code>
            </li>
          </ul>
          <p className="" />
        </li>
